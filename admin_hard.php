...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $conn->prepare("INSERT INTO hard_questions (question, answer_a, answer_b, answer_c, answer_d, correct_answer, image_path) VALUES (?, ?, ?, ?, ?, ?, ?)");
            ...
            <ul>
                <?php foreach ($questions as $question): ?>
                    <li>
                        ...
                        <?php endif; ?>
                        <a href="edit_question3.php?id=<?php echo $question['id']; ?>">Edit</a>
                        <a href="delete_question3.php?id=<?php echo $question['id']; ?>">Delete</a>
